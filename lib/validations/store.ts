...
export const CreateStoreSchema = z.object({
  ...
  bannerText: z.string().max(240, "Banner text must be 240 characters or less").optional(),
  primaryColor: colorHex.optional(),
  phone: z.string().optional(),
  email: z.string().email().optional(),
  address: z.string().optional(),
  storeAddress: z.string().max(500, "Store address must be 500 characters or less").optional(),
